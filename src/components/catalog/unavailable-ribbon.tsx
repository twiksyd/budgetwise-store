...
export function UnavailableRibbon() {
  return (
    <div className="absolute top-[16%] left-1/2 w-[200%] -translate-x-1/2 -rotate-45 bg-black/60 py-1.5 text-center text-[10px] font-bold tracking-[0.15em] text-white shadow-md sm:text-xs">
      UNAVAILABLE
    </div>
  );
}
